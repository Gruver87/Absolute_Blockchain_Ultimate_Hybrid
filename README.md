...
[![Release](https://img.shields.io/badge/Release-v1.3.35-blue)](RELEASE_NOTES_v1.3.35.md)
...
| | |
|---|---|
| **Release** | **v1.3.35** - [notes](RELEASE_NOTES_v1.3.35.md) — [CHANGELOG](CHANGELOG.md) |
...
| Jul 21 | 48h soak PASS · **v1.2.85**–**v1.3.35** industrial hardening wave |

Details: [EVIDENCE_MATRIX](docs/EVIDENCE_MATRIX.md) · [RELEASE_NOTES_v1.3.35](RELEASE_NOTES_v1.3.35.md)
...
*Last update: 2026-07-21 — **v1.3.35** (MiniVM/ZK/Lightning/DAO honesty + relayer status). Not a launched public mainnet.*

...
[![Release](https://img.shields.io/badge/Release-v1.2.99-blue)](RELEASE_NOTES_v1.2.99.md)
...
| | |
|---|---|
| **Release** | **v1.2.99** - [notes](RELEASE_NOTES_v1.2.99.md) — [CHANGELOG](CHANGELOG.md) |
...
| Jul 21 | 48h soak PASS · **v1.2.85**–**v1.2.99** industrial hardening wave |

Details: [EVIDENCE_MATRIX](docs/EVIDENCE_MATRIX.md) · [RELEASE_NOTES_v1.2.99](RELEASE_NOTES_v1.2.99.md)
...
*Last update: 2026-07-21 — **v1.2.99** (state-root encoding honesty API, harness check). Not a launched public mainnet.*

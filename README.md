...
[![Release](https://img.shields.io/badge/Release-v1.3.44-blue)](RELEASE_NOTES_v1.3.44.md)
...
| | |
|---|---|
| **Release** | **v1.3.44** - [notes](RELEASE_NOTES_v1.3.44.md) — [CHANGELOG](CHANGELOG.md) |
...
| Jul 21 | 48h soak PASS · **v1.2.85**–**v1.3.44** industrial hardening + native kernels |

Details: [EVIDENCE_MATRIX](docs/EVIDENCE_MATRIX.md) · [RELEASE_NOTES_v1.3.44](RELEASE_NOTES_v1.3.44.md)
...
*Last update: 2026-07-21 — **v1.3.44** (EVM host-in-apply fee effects). Not a launched public mainnet.*

...
[![Release](https://img.shields.io/badge/Release-v1.3.66-blue)](RELEASE_NOTES_v1.3.66.md)
...
| | |
|---|---|
| **Release** | **v1.3.66** - [notes](RELEASE_NOTES_v1.3.66.md) — [CHANGELOG](CHANGELOG.md) |
...
*Last update: 2026-07-25 — **v1.3.66** (load/backpressure). Not a launched public mainnet.*

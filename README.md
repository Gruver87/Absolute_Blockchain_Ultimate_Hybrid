...
[![Release](https://img.shields.io/badge/Release-v1.3.36-blue)](RELEASE_NOTES_v1.3.36.md)
...
| | |
|---|---|
| **Release** | **v1.3.36** - [notes](RELEASE_NOTES_v1.3.36.md) — [CHANGELOG](CHANGELOG.md) |
...
| Jul 21 | 48h soak PASS · **v1.2.85**–**v1.3.36** industrial hardening wave |

Details: [EVIDENCE_MATRIX](docs/EVIDENCE_MATRIX.md) · [RELEASE_NOTES_v1.3.36](RELEASE_NOTES_v1.3.36.md)
...
*Last update: 2026-07-21 — **v1.3.36** (WASM/finality/reorg/RANDAO honesty + atomic chain replace). Not a launched public mainnet.*

...
[![Release](https://img.shields.io/badge/Release-v1.3.73-blue)](RELEASE_NOTES_v1.3.73.md)
...
| | |
|---|---|
| **Release** | **v1.3.73** - [notes](RELEASE_NOTES_v1.3.73.md) — [CHANGELOG](CHANGELOG.md) |
...
*Last update: 2026-07-25 — **v1.3.73** (apply priority lanes). Not a launched public mainnet.*

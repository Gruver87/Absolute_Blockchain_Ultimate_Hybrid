...
[![Release](https://img.shields.io/badge/Release-v1.3.14-blue)](RELEASE_NOTES_v1.3.14.md)
...
| | |
|---|---|
| **Release** | **v1.3.14** - [notes](RELEASE_NOTES_v1.3.14.md) — [CHANGELOG](CHANGELOG.md) |
...
| Jul 21 | 48h soak PASS · **v1.2.85**–**v1.3.14** industrial hardening wave |

Details: [EVIDENCE_MATRIX](docs/EVIDENCE_MATRIX.md) · [RELEASE_NOTES_v1.3.14](RELEASE_NOTES_v1.3.14.md)
...
*Last update: 2026-07-21 — **v1.3.14** (SQLite↔Rocks reorg parity + L1 probe honesty). Not a launched public mainnet.*

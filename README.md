...
[![Release](https://img.shields.io/badge/Release-v1.3.31-blue)](RELEASE_NOTES_v1.3.31.md)
...
| | |
|---|---|
| **Release** | **v1.3.31** - [notes](RELEASE_NOTES_v1.3.31.md) — [CHANGELOG](CHANGELOG.md) |
...
| Jul 21 | 48h soak PASS · **v1.2.85**–**v1.3.31** industrial hardening wave |

Details: [EVIDENCE_MATRIX](docs/EVIDENCE_MATRIX.md) · [RELEASE_NOTES_v1.3.31](RELEASE_NOTES_v1.3.31.md)
...
*Last update: 2026-07-21 — **v1.3.31** (oracle quorum / sync finally / peer fork / bridge-MEV-AI-will). Not a launched public mainnet.*

...
[![Release](https://img.shields.io/badge/Release-v1.2.83-blue)](RELEASE_NOTES_v1.2.83.md)
...
| Field | Value |
|-------|-------|
| **Version** | `1.2.0-industrial` (latest release **v1.2.83** — IMS reconcile honesty; see [CHANGELOG](CHANGELOG.md)) |
...
| Release notes | [v1.2.83](RELEASE_NOTES_v1.2.83.md) · [v1.2.82](RELEASE_NOTES_v1.2.82.md) · [v1.2.81](RELEASE_NOTES_v1.2.81.md) · [Evidence matrix](docs/EVIDENCE_MATRIX.md) |
...
**Latest release:** [v1.2.83](RELEASE_NOTES_v1.2.83.md) — IMS reconcile honesty + satoshi reads; 48h soak **running**, not PASS yet.
...
*Last update: July 2026 — latest release **[v1.2.83](RELEASE_NOTES_v1.2.83.md)** (IMS reconcile; 48h soak running, not PASS yet). **Not** a launched public mainnet — evidence ledger: [docs/EVIDENCE_MATRIX.md](docs/EVIDENCE_MATRIX.md).*

...
[![Release](https://img.shields.io/badge/Release-v1.2.92-blue)](RELEASE_NOTES_v1.2.92.md)
...
| | |
|---|---|
| **Release** | **v1.2.92** - [notes](RELEASE_NOTES_v1.2.92.md) — [CHANGELOG](CHANGELOG.md) |
...
| Jul 21 | 48h soak PASS · **v1.2.85**–**v1.2.92** industrial hardening wave |

Details: [EVIDENCE_MATRIX](docs/EVIDENCE_MATRIX.md) · [RELEASE_NOTES_v1.2.92](RELEASE_NOTES_v1.2.92.md)
...
*Last update: 2026-07-21 — **v1.2.92** (mining fail-loud, state_root encoding scaffold, cert-manager example). Not a launched public mainnet. Evidence: [docs/EVIDENCE_MATRIX.md](docs/EVIDENCE_MATRIX.md).*

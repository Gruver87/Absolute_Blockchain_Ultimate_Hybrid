...
[![Release](https://img.shields.io/badge/Release-v1.3.30-blue)](RELEASE_NOTES_v1.3.30.md)
...
| | |
|---|---|
| **Release** | **v1.3.30** - [notes](RELEASE_NOTES_v1.3.30.md) — [CHANGELOG](CHANGELOG.md) |
...
| Jul 21 | 48h soak PASS · **v1.2.85**–**v1.3.30** industrial hardening wave |

Details: [EVIDENCE_MATRIX](docs/EVIDENCE_MATRIX.md) · [RELEASE_NOTES_v1.3.30](RELEASE_NOTES_v1.3.30.md)
...
*Last update: 2026-07-21 — **v1.3.30** (ready/WS / feature init / bridge proof / L2 missing / storage / consensus). Not a launched public mainnet.*

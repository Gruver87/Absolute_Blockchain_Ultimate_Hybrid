...
[![Release](https://img.shields.io/badge/Release-v1.3.12-blue)](RELEASE_NOTES_v1.3.12.md)
...
| | |
|---|---|
| **Release** | **v1.3.12** - [notes](RELEASE_NOTES_v1.3.12.md) — [CHANGELOG](CHANGELOG.md) |
...
| Jul 21 | 48h soak PASS · **v1.2.85**–**v1.3.12** industrial hardening wave |

Details: [EVIDENCE_MATRIX](docs/EVIDENCE_MATRIX.md) · [RELEASE_NOTES_v1.3.12](RELEASE_NOTES_v1.3.12.md)
...
*Last update: 2026-07-21 — **v1.3.12** (wire-probe fail-closed + ready/compose freeze). Not a launched public mainnet.*

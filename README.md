...
[![Release v1.3.96](https://img.shields.io/badge/Release-v1.3.96-blue)](RELEASE_NOTES_v1.3.96.md)
...
| | |
|---|---|
| **Release** | **v1.3.96** — [notes](RELEASE_NOTES_v1.3.96.md) · [CHANGELOG](CHANGELOG.md) · [Releases](https://github.com/Gruver87/Absolute_Blockchain_Ultimate_Hybrid/releases) |
...
| Jul 21–25 | Industrial waves **v1.3.65–v1.3.96** · native handshake I/O · batch pumps · TCP+TLS · Sybil/Eclipse |

Details: [EVIDENCE_MATRIX](docs/EVIDENCE_MATRIX.md) · [RELEASE_NOTES_v1.3.96](RELEASE_NOTES_v1.3.96.md)
...
*Last update: 2026-07-25 — **v1.3.96** + native P2P handshake_roundtrip. Not a launched public mainnet.*

...
[![Release](https://img.shields.io/badge/Release-v1.3.72-blue)](RELEASE_NOTES_v1.3.72.md)
...
| | |
|---|---|
| **Release** | **v1.3.72** - [notes](RELEASE_NOTES_v1.3.72.md) — [CHANGELOG](CHANGELOG.md) |
...
*Last update: 2026-07-25 — **v1.3.72** (P2P sync admission). Not a launched public mainnet.*

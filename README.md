...
[![Release](https://img.shields.io/badge/Release-v1.3.64-blue)](RELEASE_NOTES_v1.3.64.md)
...
| | |
|---|---|
| **Release** | **v1.3.64** - [notes](RELEASE_NOTES_v1.3.64.md) — [CHANGELOG](CHANGELOG.md) |
...
*Last update: 2026-07-25 — **v1.3.64** (Rocks writeback account preload). Not a launched public mainnet.*

...
[![Release](https://img.shields.io/badge/Release-v1.3.70-blue)](RELEASE_NOTES_v1.3.70.md)
...
| | |
|---|---|
| **Release** | **v1.3.70** - [notes](RELEASE_NOTES_v1.3.70.md) — [CHANGELOG](CHANGELOG.md) |
...
*Last update: 2026-07-25 — **v1.3.70** (recursive frame arena sync). Not a launched public mainnet.*

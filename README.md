...
[![Release](https://img.shields.io/badge/Release-v1.3.23-blue)](RELEASE_NOTES_v1.3.23.md)
...
| | |
|---|---|
| **Release** | **v1.3.23** - [notes](RELEASE_NOTES_v1.3.23.md) — [CHANGELOG](CHANGELOG.md) |
...
| Jul 21 | 48h soak PASS · **v1.2.85**–**v1.3.23** industrial hardening wave |

Details: [EVIDENCE_MATRIX](docs/EVIDENCE_MATRIX.md) · [RELEASE_NOTES_v1.3.23](RELEASE_NOTES_v1.3.23.md)
...
*Last update: 2026-07-21 — **v1.3.23** (P2P bind / ready wire / status / peers mining). Not a launched public mainnet.*

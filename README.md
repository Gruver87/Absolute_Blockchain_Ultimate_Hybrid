...
[![Release](https://img.shields.io/badge/Release-v1.3.37-blue)](RELEASE_NOTES_v1.3.37.md)
...
| | |
|---|---|
| **Release** | **v1.3.37** - [notes](RELEASE_NOTES_v1.3.37.md) — [CHANGELOG](CHANGELOG.md) |
...
| Jul 21 | 48h soak PASS · **v1.2.85**–**v1.3.37** industrial hardening wave |

Details: [EVIDENCE_MATRIX](docs/EVIDENCE_MATRIX.md) · [RELEASE_NOTES_v1.3.37](RELEASE_NOTES_v1.3.37.md)
...
*Last update: 2026-07-21 — **v1.3.37** (bridge L1-proof / light / PBS / AI honesty). Not a launched public mainnet.*

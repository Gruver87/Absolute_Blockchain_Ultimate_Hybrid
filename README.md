...
[![Release](https://img.shields.io/badge/Release-v1.3.80-blue)](RELEASE_NOTES_v1.3.80.md)
...
| | |
|---|---|
| **Release** | **v1.3.80** - [notes](RELEASE_NOTES_v1.3.80.md) — [CHANGELOG](CHANGELOG.md) |
...
*Last update: 2026-07-25 — **v1.3.80** (simple CREATE). Not a launched public mainnet.*

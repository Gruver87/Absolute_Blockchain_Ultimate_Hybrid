...
[![Release](https://img.shields.io/badge/Release-v1.3.79-blue)](RELEASE_NOTES_v1.3.79.md)
...
| | |
|---|---|
| **Release** | **v1.3.79** - [notes](RELEASE_NOTES_v1.3.79.md) — [CHANGELOG](CHANGELOG.md) |
...
*Last update: 2026-07-25 — **v1.3.79** (CALLCODE value). Not a launched public mainnet.*

...
[![Release](https://img.shields.io/badge/Release-v1.3.76-blue)](RELEASE_NOTES_v1.3.76.md)
...
| | |
|---|---|
| **Release** | **v1.3.76** - [notes](RELEASE_NOTES_v1.3.76.md) — [CHANGELOG](CHANGELOG.md) |
...
*Last update: 2026-07-25 — **v1.3.76** (value CALL ownership). Not a launched public mainnet.*

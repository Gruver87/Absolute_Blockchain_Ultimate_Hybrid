...
[![Release](https://img.shields.io/badge/Release-v1.3.09-blue)](RELEASE_NOTES_v1.3.09.md)
...
| | |
|---|---|
| **Release** | **v1.3.09** - [notes](RELEASE_NOTES_v1.3.09.md) — [CHANGELOG](CHANGELOG.md) |
...
| Jul 21 | 48h soak PASS · **v1.2.85**–**v1.3.09** industrial hardening wave |

Details: [EVIDENCE_MATRIX](docs/EVIDENCE_MATRIX.md) · [RELEASE_NOTES_v1.3.09](RELEASE_NOTES_v1.3.09.md)
...
*Last update: 2026-07-21 — **v1.3.09** (pre-ban strike logs + k8s embed freeze). Not a launched public mainnet.*

...
[![Release](https://img.shields.io/badge/Release-v1.3.27-blue)](RELEASE_NOTES_v1.3.27.md)
...
| | |
|---|---|
| **Release** | **v1.3.27** - [notes](RELEASE_NOTES_v1.3.27.md) — [CHANGELOG](CHANGELOG.md) |
...
| Jul 21 | 48h soak PASS · **v1.2.85**–**v1.3.27** industrial hardening wave |

Details: [EVIDENCE_MATRIX](docs/EVIDENCE_MATRIX.md) · [RELEASE_NOTES_v1.3.27](RELEASE_NOTES_v1.3.27.md)
...
*Last update: 2026-07-21 — **v1.3.27** (Rocks decode / catch_up / IMS missing / get_meta). Not a launched public mainnet.*

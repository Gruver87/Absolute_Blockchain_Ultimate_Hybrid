...
[![Release](https://img.shields.io/badge/Release-v1.3.84-blue)](RELEASE_NOTES_v1.3.84.md)
...
| | |
|---|---|
| **Release** | **v1.3.84** - [notes](RELEASE_NOTES_v1.3.84.md) — [CHANGELOG](CHANGELOG.md) |
...
| Jul 21–25 | 48h soak PASS · **v1.2.85**–**v1.3.64** industrial hardening + native kernels |

Details: [EVIDENCE_MATRIX](docs/EVIDENCE_MATRIX.md) · [RELEASE_NOTES_v1.3.64](RELEASE_NOTES_v1.3.64.md)
...
*Last update: 2026-07-25 — **v1.3.84** (inline CREATE save_account journal). Not a launched public mainnet.*

...
[![Release](https://img.shields.io/badge/Release-v1.3.32-blue)](RELEASE_NOTES_v1.3.32.md)
...
| | |
|---|---|
| **Release** | **v1.3.32** - [notes](RELEASE_NOTES_v1.3.32.md) — [CHANGELOG](CHANGELOG.md) |
...
| Jul 21 | 48h soak PASS · **v1.2.85**–**v1.3.32** industrial hardening wave |

Details: [EVIDENCE_MATRIX](docs/EVIDENCE_MATRIX.md) · [RELEASE_NOTES_v1.3.32](RELEASE_NOTES_v1.3.32.md)
...
*Last update: 2026-07-21 — **v1.3.32** (L1 receipt / EVM static / NFT-PQ-will-multisig honesty). Not a launched public mainnet.*

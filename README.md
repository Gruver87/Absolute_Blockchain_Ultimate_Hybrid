...
[![Release](https://img.shields.io/badge/Release-v1.3.74-blue)](RELEASE_NOTES_v1.3.74.md)
...
| | |
|---|---|
| **Release** | **v1.3.74** - [notes](RELEASE_NOTES_v1.3.74.md) — [CHANGELOG](CHANGELOG.md) |
...
*Last update: 2026-07-25 — **v1.3.74** (value=0 CALL inline). Not a launched public mainnet.*

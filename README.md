...
[![Release](https://img.shields.io/badge/Release-v1.3.33-blue)](RELEASE_NOTES_v1.3.33.md)
...
| | |
|---|---|
| **Release** | **v1.3.33** - [notes](RELEASE_NOTES_v1.3.33.md) — [CHANGELOG](CHANGELOG.md) |
...
| Jul 21 | 48h soak PASS · **v1.2.85**–**v1.3.33** industrial hardening wave |

Details: [EVIDENCE_MATRIX](docs/EVIDENCE_MATRIX.md) · [RELEASE_NOTES_v1.3.33](RELEASE_NOTES_v1.3.33.md)
...
*Last update: 2026-07-21 — **v1.3.33** (bridge event replay / plasma force / smart-accounts). Not a launched public mainnet.*

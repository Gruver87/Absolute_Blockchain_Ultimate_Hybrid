...
[![Release](https://img.shields.io/badge/Release-v1.3.77-blue)](RELEASE_NOTES_v1.3.77.md)
...
| | |
|---|---|
| **Release** | **v1.3.77** - [notes](RELEASE_NOTES_v1.3.77.md) — [CHANGELOG](CHANGELOG.md) |
...
*Last update: 2026-07-25 — **v1.3.77** (Rust P2P ingress). Not a launched public mainnet.*

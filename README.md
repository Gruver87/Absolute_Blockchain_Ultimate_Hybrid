...
[![Release](https://img.shields.io/badge/Release-v1.3.41-blue)](RELEASE_NOTES_v1.3.41.md)
...
| | |
|---|---|
| **Release** | **v1.3.41** - [notes](RELEASE_NOTES_v1.3.41.md) — [CHANGELOG](CHANGELOG.md) |
...
| Jul 21 | 48h soak PASS · **v1.2.85**–**v1.3.41** industrial hardening + native GHOST/FFG/eth_tx/EVM snap |

Details: [EVIDENCE_MATRIX](docs/EVIDENCE_MATRIX.md) · [RELEASE_NOTES_v1.3.41](RELEASE_NOTES_v1.3.41.md)
...
*Last update: 2026-07-21 — **v1.3.41** (EVM host storage snapshot). Not a launched public mainnet.*

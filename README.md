...
[![Release](https://img.shields.io/badge/Release-v1.2.82-blue)](RELEASE_NOTES_v1.2.82.md)
...
| Field | Value |
|-------|-------|
| **Version** | `1.2.0-industrial` (latest release **v1.2.82** — balance write-path unify; see [CHANGELOG](CHANGELOG.md)) |
...
| Release notes | [v1.2.82](RELEASE_NOTES_v1.2.82.md) · [v1.2.81](RELEASE_NOTES_v1.2.81.md) · [v1.2.80](RELEASE_NOTES_v1.2.80.md) · [Evidence matrix](docs/EVIDENCE_MATRIX.md) |
...
**Latest release:** [v1.2.82](RELEASE_NOTES_v1.2.82.md) — balance write-path unify; 48h soak **running**, not PASS yet.
...
*Last update: July 2026 — latest release **[v1.2.82](RELEASE_NOTES_v1.2.82.md)** (write-path unify; 48h soak running, not PASS yet). **Not** a launched public mainnet — evidence ledger: [docs/EVIDENCE_MATRIX.md](docs/EVIDENCE_MATRIX.md).*

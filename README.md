...
[![Release](https://img.shields.io/badge/Release-v1.3.39-blue)](RELEASE_NOTES_v1.3.39.md)
...
| | |
|---|---|
| **Release** | **v1.3.39** - [notes](RELEASE_NOTES_v1.3.39.md) — [CHANGELOG](CHANGELOG.md) |
...
| Jul 21 | 48h soak PASS · **v1.2.85**–**v1.3.39** industrial hardening + native GHOST/FFG |

Details: [EVIDENCE_MATRIX](docs/EVIDENCE_MATRIX.md) · [RELEASE_NOTES_v1.3.39](RELEASE_NOTES_v1.3.39.md)
...
*Last update: 2026-07-21 — **v1.3.39** (native FFG finality + slashing conflict kernels). Not a launched public mainnet.*

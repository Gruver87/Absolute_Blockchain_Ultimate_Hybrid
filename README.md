...
[![Release](https://img.shields.io/badge/Release-v1.3.19-blue)](RELEASE_NOTES_v1.3.19.md)
...
| | |
|---|---|
| **Release** | **v1.3.19** - [notes](RELEASE_NOTES_v1.3.19.md) — [CHANGELOG](CHANGELOG.md) |
...
| Jul 21 | 48h soak PASS · **v1.2.85**–**v1.3.19** industrial hardening wave |

Details: [EVIDENCE_MATRIX](docs/EVIDENCE_MATRIX.md) · [RELEASE_NOTES_v1.3.19](RELEASE_NOTES_v1.3.19.md)
...
*Last update: 2026-07-21 — **v1.3.19** (sync incomplete, CORS, repair, receipt fail-closed). Not a launched public mainnet.*

...
[![Release](https://img.shields.io/badge/Release-v1.2.90-blue)](RELEASE_NOTES_v1.2.90.md)
...
| | |
|---|---|
| **Release** | **v1.2.90** - [notes](RELEASE_NOTES_v1.2.90.md) — [CHANGELOG](CHANGELOG.md) |
...
| Jul 21 | 48h soak PASS · **v1.2.85** · pre-audit polish **v1.2.86** (fail-closed + TLS default) · **v1.2.87** — **v1.2.88** — **v1.2.90** |

Details: [EVIDENCE_MATRIX](docs/EVIDENCE_MATRIX.md) · [RELEASE_NOTES_v1.2.90](RELEASE_NOTES_v1.2.90.md)
...
*Last update: 2026-07-21 — **v1.2.90** (soak honesty, Redis RL fail-closed, single-node P2P TLS; 48h soak PASS). Not a launched public mainnet. Evidence: [docs/EVIDENCE_MATRIX.md](docs/EVIDENCE_MATRIX.md).*

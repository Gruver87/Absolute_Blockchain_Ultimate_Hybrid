...
[![Release](https://img.shields.io/badge/Release-v1.3.40-blue)](RELEASE_NOTES_v1.3.40.md)
...
| | |
|---|---|
| **Release** | **v1.3.40** - [notes](RELEASE_NOTES_v1.3.40.md) — [CHANGELOG](CHANGELOG.md) |
...
| Jul 21 | 48h soak PASS · **v1.2.85**–**v1.3.40** industrial hardening + native GHOST/FFG/eth_tx |

Details: [EVIDENCE_MATRIX](docs/EVIDENCE_MATRIX.md) · [RELEASE_NOTES_v1.3.40](RELEASE_NOTES_v1.3.40.md)
...
*Last update: 2026-07-21 — **v1.3.40** (native eth raw tx decode). Not a launched public mainnet.*

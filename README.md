...
[![Release](https://img.shields.io/badge/Release-v1.3.34-blue)](RELEASE_NOTES_v1.3.34.md)
...
| | |
|---|---|
| **Release** | **v1.3.34** - [notes](RELEASE_NOTES_v1.3.34.md) — [CHANGELOG](CHANGELOG.md) |
...
| Jul 21 | 48h soak PASS · **v1.2.85**–**v1.3.34** industrial hardening wave |

Details: [EVIDENCE_MATRIX](docs/EVIDENCE_MATRIX.md) · [RELEASE_NOTES_v1.3.34](RELEASE_NOTES_v1.3.34.md)
...
*Last update: 2026-07-21 — **v1.3.34** (Rust L1 lock verify / event-log address / atomic debit). Not a launched public mainnet.*

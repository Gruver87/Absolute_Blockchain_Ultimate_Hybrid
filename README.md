...
[![Release](https://img.shields.io/badge/Release-v1.3.04-blue)](RELEASE_NOTES_v1.3.04.md)
...
| | |
|---|---|
| **Release** | **v1.3.04** - [notes](RELEASE_NOTES_v1.3.04.md) — [CHANGELOG](CHANGELOG.md) |
...
| Jul 21 | 48h soak PASS · **v1.2.85**–**v1.3.04** industrial hardening wave |

Details: [EVIDENCE_MATRIX](docs/EVIDENCE_MATRIX.md) · [RELEASE_NOTES_v1.3.04](RELEASE_NOTES_v1.3.04.md)
...
*Last update: 2026-07-21 — **v1.3.04** (wire-reject + P2P alerts + Rocks parity). Not a launched public mainnet.*

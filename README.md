...
[![Release v1.3.91](https://img.shields.io/badge/Release-v1.3.91-blue)](RELEASE_NOTES_v1.3.91.md)
...
| | |
|---|---|
| **Release** | **v1.3.91** — [notes](RELEASE_NOTES_v1.3.91.md) · [CHANGELOG](CHANGELOG.md) · [Releases](https://github.com/Gruver87/Absolute_Blockchain_Ultimate_Hybrid/releases) |
...
| Jul 21–25 | Industrial waves **v1.3.65–v1.3.91** · native TCP+TLS transport · Sybil/Eclipse · fuzz · `check_all` |

Details: [EVIDENCE_MATRIX](docs/EVIDENCE_MATRIX.md) · [RELEASE_NOTES_v1.3.91](RELEASE_NOTES_v1.3.91.md)
...
*Last update: 2026-07-25 — **v1.3.91** + native rustls P2P TLS. Not a launched public mainnet.*

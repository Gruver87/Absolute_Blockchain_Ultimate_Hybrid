...
[![Release](https://img.shields.io/badge/Release-v1.3.78-blue)](RELEASE_NOTES_v1.3.78.md)
...
| | |
|---|---|
| **Release** | **v1.3.78** - [notes](RELEASE_NOTES_v1.3.78.md) — [CHANGELOG](CHANGELOG.md) |
...
*Last update: 2026-07-25 — **v1.3.78** (P2P bandwidth budget). Not a launched public mainnet.*

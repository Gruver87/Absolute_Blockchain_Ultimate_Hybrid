...
[![Release](https://img.shields.io/badge/Release-v1.3.83-blue)](RELEASE_NOTES_v1.3.83.md)
...
| | |
|---|---|
| **Release** | **v1.3.83** - [notes](RELEASE_NOTES_v1.3.83.md) — [CHANGELOG](CHANGELOG.md) |
...
*Last update: 2026-07-25 — **v1.3.83** (inline value → writeback journal). Not a launched public mainnet.*

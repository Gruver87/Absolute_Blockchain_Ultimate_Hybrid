...
[![Release](https://img.shields.io/badge/Release-v1.3.82-blue)](RELEASE_NOTES_v1.3.82.md)
...
| | |
|---|---|
| **Release** | **v1.3.82** - [notes](RELEASE_NOTES_v1.3.82.md) — [CHANGELOG](CHANGELOG.md) |
...
*Last update: 2026-07-25 — **v1.3.82** (CREATE RETURN runtime). Not a launched public mainnet.*

...
[![Release](https://img.shields.io/badge/Release-v1.3.85-blue)](RELEASE_NOTES_v1.3.85.md)
...
| | |
|---|---|
| **Release** | **v1.3.85** - [notes](RELEASE_NOTES_v1.3.85.md) — [CHANGELOG](CHANGELOG.md) |
...
*Last update: 2026-07-25 — **v1.3.85** (P2P outbound egress bandwidth). Not a launched public mainnet.*

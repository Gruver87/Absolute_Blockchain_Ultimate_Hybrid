...
[![Release](https://img.shields.io/badge/Release-v1.3.29-blue)](RELEASE_NOTES_v1.3.29.md)
...
| | |
|---|---|
| **Release** | **v1.3.29** - [notes](RELEASE_NOTES_v1.3.29.md) — [CHANGELOG](CHANGELOG.md) |
...
| Jul 21 | 48h soak PASS · **v1.2.85**–**v1.3.29** industrial hardening wave |

Details: [EVIDENCE_MATRIX](docs/EVIDENCE_MATRIX.md) · [RELEASE_NOTES_v1.3.29](RELEASE_NOTES_v1.3.29.md)
...
*Last update: 2026-07-21 — **v1.3.29** (topology/prod / filters / migrate / SQLite features / metrics-WS / tip). Not a launched public mainnet.*

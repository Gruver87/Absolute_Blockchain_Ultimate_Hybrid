...
[![Release](https://img.shields.io/badge/Release-v1.3.25-blue)](RELEASE_NOTES_v1.3.25.md)
...
| | |
|---|---|
| **Release** | **v1.3.25** - [notes](RELEASE_NOTES_v1.3.25.md) — [CHANGELOG](CHANGELOG.md) |
...
| Jul 21 | 48h soak PASS · **v1.2.85**–**v1.3.25** industrial hardening wave |

Details: [EVIDENCE_MATRIX](docs/EVIDENCE_MATRIX.md) · [RELEASE_NOTES_v1.3.25](RELEASE_NOTES_v1.3.25.md)
...
*Last update: 2026-07-21 — **v1.3.25** (supply / point-gets / broadcast_fail / core_real). Not a launched public mainnet.*

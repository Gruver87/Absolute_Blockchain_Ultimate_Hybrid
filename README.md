...
[![Release](https://img.shields.io/badge/Release-v1.3.69-blue)](RELEASE_NOTES_v1.3.69.md)
...
| | |
|---|---|
| **Release** | **v1.3.69** - [notes](RELEASE_NOTES_v1.3.69.md) — [CHANGELOG](CHANGELOG.md) |
...
*Last update: 2026-07-25 — **v1.3.69** (block session + verify script). Not a launched public mainnet.*

...
[![Release](https://img.shields.io/badge/Release-v1.3.24-blue)](RELEASE_NOTES_v1.3.24.md)
...
| | |
|---|---|
| **Release** | **v1.3.24** - [notes](RELEASE_NOTES_v1.3.24.md) — [CHANGELOG](CHANGELOG.md) |
...
| Jul 21 | 48h soak PASS · **v1.2.85**–**v1.3.24** industrial hardening wave |

Details: [EVIDENCE_MATRIX](docs/EVIDENCE_MATRIX.md) · [RELEASE_NOTES_v1.3.24](RELEASE_NOTES_v1.3.24.md)
...
*Last update: 2026-07-21 — **v1.3.24** (core engines / status wire / IMS canonical). Not a launched public mainnet.*

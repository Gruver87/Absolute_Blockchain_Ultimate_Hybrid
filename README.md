...
[![Release](https://img.shields.io/badge/Release-v1.2.93-blue)](RELEASE_NOTES_v1.2.93.md)
...
| | |
|---|---|
| **Release** | **v1.2.93** - [notes](RELEASE_NOTES_v1.2.93.md) — [CHANGELOG](CHANGELOG.md) |
...
| Jul 21 | 48h soak PASS · **v1.2.85**–**v1.2.93** industrial hardening wave |

Details: [EVIDENCE_MATRIX](docs/EVIDENCE_MATRIX.md) · [RELEASE_NOTES_v1.2.93](RELEASE_NOTES_v1.2.93.md)
...
*Last update: 2026-07-21 — **v1.2.93** (API repair fail-loud, verify_p2p strict skips, state_root migration doc). Not a launched public mainnet.*

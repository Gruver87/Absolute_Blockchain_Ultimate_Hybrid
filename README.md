...
[![Release](https://img.shields.io/badge/Release-v1.3.38-blue)](RELEASE_NOTES_v1.3.38.md)
...
| | |
|---|---|
| **Release** | **v1.3.38** - [notes](RELEASE_NOTES_v1.3.38.md) — [CHANGELOG](CHANGELOG.md) |
...
| Jul 21 | 48h soak PASS · **v1.2.85**–**v1.3.38** industrial hardening + native GHOST/apply |

Details: [EVIDENCE_MATRIX](docs/EVIDENCE_MATRIX.md) · [RELEASE_NOTES_v1.3.38](RELEASE_NOTES_v1.3.38.md)
...
*Last update: 2026-07-21 — **v1.3.38** (native GHOST + simple block apply/replay). Not a launched public mainnet.*

...
[![Release](https://img.shields.io/badge/Release-v1.3.28-blue)](RELEASE_NOTES_v1.3.28.md)
...
| | |
|---|---|
| **Release** | **v1.3.28** - [notes](RELEASE_NOTES_v1.3.28.md) — [CHANGELOG](CHANGELOG.md) |
...
| Jul 21 | 48h soak PASS · **v1.2.85**–**v1.3.28** industrial hardening wave |

Details: [EVIDENCE_MATRIX](docs/EVIDENCE_MATRIX.md) · [RELEASE_NOTES_v1.3.28](RELEASE_NOTES_v1.3.28.md)
...
*Last update: 2026-07-21 — **v1.3.28** (mining/status / WS-P2P send / API missing / clone / SQLite / amount). Not a launched public mainnet.*

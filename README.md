...
[![Release](https://img.shields.io/badge/Release-v1.3.75-blue)](RELEASE_NOTES_v1.3.75.md)
...
| | |
|---|---|
| **Release** | **v1.3.75** - [notes](RELEASE_NOTES_v1.3.75.md) — [CHANGELOG](CHANGELOG.md) |
...
*Last update: 2026-07-25 — **v1.3.75** (multi-depth CALL). Not a launched public mainnet.*

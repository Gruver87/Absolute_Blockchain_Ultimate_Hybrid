...
[![Release](https://img.shields.io/badge/Release-v1.3.65-blue)](RELEASE_NOTES_v1.3.65.md)
...
| | |
|---|---|
| **Release** | **v1.3.65** - [notes](RELEASE_NOTES_v1.3.65.md) — [CHANGELOG](CHANGELOG.md) |
...
*Last update: 2026-07-25 — **v1.3.65** (L1 fail-closed hardening). Not a launched public mainnet.*

...
[![Release](https://img.shields.io/badge/Release-v1.3.50-blue)](RELEASE_NOTES_v1.3.50.md)
...
| | |
|---|---|
| **Release** | **v1.3.50** - [notes](RELEASE_NOTES_v1.3.50.md) — [CHANGELOG](CHANGELOG.md) |
...
| Jul 21–25 | 48h soak PASS · **v1.2.85**–**v1.3.50** industrial hardening + native kernels |

Details: [EVIDENCE_MATRIX](docs/EVIDENCE_MATRIX.md) · [RELEASE_NOTES_v1.3.50](RELEASE_NOTES_v1.3.50.md)
...
*Last update: 2026-07-25 — **v1.3.50** (nested pure bytecode frame). Not a launched public mainnet.*

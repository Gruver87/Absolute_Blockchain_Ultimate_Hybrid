...
[![Release](https://img.shields.io/badge/Release-v1.3.08-blue)](RELEASE_NOTES_v1.3.08.md)
...
| | |
|---|---|
| **Release** | **v1.3.08** - [notes](RELEASE_NOTES_v1.3.08.md) — [CHANGELOG](CHANGELOG.md) |
...
| Jul 21 | 48h soak PASS · **v1.2.85**–**v1.3.08** industrial hardening wave |

Details: [EVIDENCE_MATRIX](docs/EVIDENCE_MATRIX.md) · [RELEASE_NOTES_v1.3.08](RELEASE_NOTES_v1.3.08.md)
...
*Last update: 2026-07-21 — **v1.3.08** (Swiss-watch ops honesty + JSON parity). Not a launched public mainnet.*

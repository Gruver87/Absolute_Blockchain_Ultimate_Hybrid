...
[![Release](https://img.shields.io/badge/Release-v1.3.20-blue)](RELEASE_NOTES_v1.3.20.md)
...
| | |
|---|---|
| **Release** | **v1.3.20** - [notes](RELEASE_NOTES_v1.3.20.md) — [CHANGELOG](CHANGELOG.md) |
...
| Jul 21 | 48h soak PASS · **v1.2.85**–**v1.3.20** industrial hardening wave |

Details: [EVIDENCE_MATRIX](docs/EVIDENCE_MATRIX.md) · [RELEASE_NOTES_v1.3.20](RELEASE_NOTES_v1.3.20.md)
...
*Last update: 2026-07-21 — **v1.3.20** (proxy CORS, receipt omit→0, ready/sync honesty). Not a launched public mainnet.*

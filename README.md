...
[![Release](https://img.shields.io/badge/Release-v1.2.98-blue)](RELEASE_NOTES_v1.2.98.md)
...
| | |
|---|---|
| **Release** | **v1.2.98** - [notes](RELEASE_NOTES_v1.2.98.md) — [CHANGELOG](CHANGELOG.md) |
...
| Jul 21 | 48h soak PASS · **v1.2.85**–**v1.2.98** industrial hardening wave |

Details: [EVIDENCE_MATRIX](docs/EVIDENCE_MATRIX.md) · [RELEASE_NOTES_v1.2.98](RELEASE_NOTES_v1.2.98.md)
...
*Last update: 2026-07-21 — **v1.2.98** (AI/MEV/PQ probes, security-audit bridge gate). Not a launched public mainnet.*

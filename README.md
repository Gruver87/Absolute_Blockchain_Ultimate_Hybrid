...
[![Release](https://img.shields.io/badge/Release-v1.3.07-blue)](RELEASE_NOTES_v1.3.07.md)
...
| | |
|---|---|
| **Release** | **v1.3.07** - [notes](RELEASE_NOTES_v1.3.07.md) — [CHANGELOG](CHANGELOG.md) |
...
| Jul 21 | 48h soak PASS · **v1.2.85**–**v1.3.07** industrial hardening wave |

Details: [EVIDENCE_MATRIX](docs/EVIDENCE_MATRIX.md) · [RELEASE_NOTES_v1.3.07](RELEASE_NOTES_v1.3.07.md)
...
*Last update: 2026-07-21 — **v1.3.07** (ops_errors metrics + mid-session handshake). Not a launched public mainnet.*

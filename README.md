...
[![Release](https://img.shields.io/badge/Release-v1.3.81-blue)](RELEASE_NOTES_v1.3.81.md)
...
| | |
|---|---|
| **Release** | **v1.3.81** - [notes](RELEASE_NOTES_v1.3.81.md) — [CHANGELOG](CHANGELOG.md) |
...
*Last update: 2026-07-25 — **v1.3.81** (CREATE2). Not a launched public mainnet.*

...
| **Industrial tip-v2 re-smoke** | **PASS** 2026-08-02 — ready×3 + probe + failover + signed tx + EVM on tip-v2 mesh; DR rehearsal PASS; ceremony pin dry-run; **48h soak STARTED** (`logs/industrial_tipv2_soak_48h.log`) — collect `passed=true` before claiming tip-v2 soak | `docs/evidence/runs/` (industrial Phase 2 pack) + [INDUSTRIAL_HARDEN_RUNBOOK.md](INDUSTRIAL_HARDEN_RUNBOOK.md) |

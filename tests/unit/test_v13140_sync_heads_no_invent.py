...
def test_needles_v13140():
    ...
    assert 'EvidenceGitTag = "v1.3.139"' in check or "v1.3.140" in check or "v1.3.141" in check or "v1.3.142" in check or "v1.3.143" in check or "v1.3.144" in check or "v1.3.145" in check or "v1.3.146" in check or "v1.3.147" in check
